  ...
  return (
    <div className="min-h-screen bg-surface-lowest flex items-center justify-center relative overflow-hidden">
      ...
      >
        ...
        <Link
          href="/consulta"
          className="inline-flex items-center gap-2 px-6 py-2.5 bg-surface-container hover:bg-surface-high text-on-surface border border-outline-variant font-medium rounded-lg transition-all duration-200 text-[13px]"
          style={{
            opacity: visible ? 1 : 0,
