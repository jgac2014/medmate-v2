  ...
  return (
    <div className="w-full max-w-sm">
      <div className="text-center mb-8">
        ...
        <p className="text-[14px] text-on-surface-variant mt-1">Recuperação de senha</p>
      </div>
      ...
      <div className="bg-white border border-outline-variant rounded-2xl p-8 shadow-[0_4px_20px_rgba(0,0,0,0.04)]">
        {success ? (
          <div className="text-center space-y-4">
            ...
            <div>
              <p className="text-[16px] font-semibold text-on-surface">Email enviado!</p>
              <p className="text-[14px] text-on-surface-variant mt-1">
                Verifique sua caixa de entrada e clique no link para redefinir sua senha.
              </p>
            </div>
            <Link href="/login" className="inline-block text-[13px] text-primary hover:underline font-medium mt-2">
              Voltar ao login
            </Link>
          </div>
        ) : (
          <>
            ...
            <p className="text-[13px] text-on-surface-muted text-center mt-4">
              Lembrou a senha?{" "}
